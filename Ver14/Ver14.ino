...
int count=0;
//********************************************
#define Analog 1//do am dat 1 analog 5
#define Analogg 5//do am dat 2 analog 5
...
{ 
  if (Check_nuoc()>=800)
  {  
     sms.SendSMS(n,"He thong da het nuoc.Dang bom nuoc du tru... ");
     mo_van();
     sms.SendSMS(n,"Bom nuoc du tru da hoan tat.");
     delay(10000);
     dong_van();
  }   
